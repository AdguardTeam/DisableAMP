...
const newTabContext = (ntc) => {
    ...
    const previewURL = ntc.getAttribute('data-amp').replace("https://", document.location.origin + "/amp/s/").replace("?", "%3f");
    ntc.setAttribute('data-amp', previewURL);
    ntc.setAttribute('data-amp-cur', previewURL);
    ntc.setAttribute('href', previewURL);
